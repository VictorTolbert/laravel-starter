...
<div class="hero-body">
    <div class="container is-fluid">
        ...
        <h2 class="subtitle">        <h2 class="subtitle">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure doloribus, quidem optio, numquam commodi unde nihil nesciunt sapiente obcaecati corporis maiores ipsam cumque magni magnam provident sed sequi, praesentium, veniam.</h2>
</h2>
    </div>
</div>
@endsection
