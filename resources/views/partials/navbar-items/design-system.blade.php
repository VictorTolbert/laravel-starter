<div class="navbar-item has-dropdown is-hoverable">
    ...
    <div id="moreDropdown" class="navbar-dropdown">
        ...
        <a class="navbar-item" href="{{ route('templates') }}">Templates</a>
        <hr class="navbar-divider">
        <a class="navbar-item" href="{{ route('colors') }}">Color</a>
        <a class="navbar-item" href="{{ route('layout') }}">Layout</a>
        <a class="navbar-item" href="{{ route('navbars') }}">Navigation</a>
        ...
        {{-- <a class="navbar-item" href="{{ route('proposal-viewer.index') }}">XML Proposal Viewer</a> --}}
    </div>
</div>
