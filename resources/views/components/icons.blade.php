...
{{--         <a v-for="(icon, index) in db.demo.icons"
            :key="index"
            class="navbar-item"
            data-show="quickview"
            data-target="target">
...
<div class="content">
        ...
        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('add-box')</span>
            <span>Add Box</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('code')</span>
            <span>Code</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('copy')</span>
            <span>Copy</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('css3-logo')</span>
            <span>CSS3 Logo</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('description')</span>
            <span>Description</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('design-system')</span>
            <span>Design System</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('documentation')</span>
            <span>Documentatin</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('favorite-border')</span>
            <span>Favorite Border</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('favorite')</span>
            <span>Favorite</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('file-download')</span>
            <span>File Download</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('file-upload')</span>
            <span>File Upload</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('filter-list')</span>
            <span>Filter List</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('format-size')</span>
            <span>Format Size</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('git-logo2')</span>
            <span>Git Logo 2</span>
        </a>
        ...
        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('html5-logo')</span>
            <span>HTML5</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('indeterminate-check-box')</span>
            <span>Indeterminate Check Box</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('javascript-logo')</span>
            <span>JavaScript Logo</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('lesson-type')</span>
            <span>Lesson Type</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('lock')</span>
            <span>Lock</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('medicine-bottle')</span>
            <span>Medicine Bottle</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('more-horizontal')</span>
            <span>More Horizontal</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('more-vertical')</span>
            <span>More Vertical</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('non-sellable')</span>
            <span>Non Sellable</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('office')</span>
            <span>Office</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('peach')</span>
            <span>Peach</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('plus')</span>
            <span>Plus</span>
        </a>
        ...
        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('prototypes')</span>
            <span>Prototypes</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('react-logo')</span>
            <span>React Logo</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('refactoring-ui')</span>
            <span>Refactoring UI</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('salesforce-logo')</span>
            <span>Salesforce Logo</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('search')</span>
            <span>Search</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('settings')</span>
            <span>Settings</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('sliders')</span>
            <span>Sliders</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('styleguide')</span>
            <span>Styleguide</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('trash')</span>
            <span>Trash</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('try')</span>
            <span>Try</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('unlock')</span>
            <span>Unlock</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('us-pixel-map-test')</span>
            <span>US Pixel Map Test</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('us-pixel-map')</span>
            <span>US Pixel Map</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('us')</span>
            <span>US</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('us1')</span>
            <span>US 1</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('usa-pixel')</span>
            <span>USA Pixel</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('usa')</span>
            <span>USA</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('uxlab-logo')</span>
            <span>UXLab Logo</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('uxlab')</span>
            <span>UXLab</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('uxpin-logo')</span>
            <span>UXPin Logo</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help" style="background: #111">
            <span class="m-r-sm">@svg('videa-logo--white')</span>
            <span>Videa Logo -- White</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('videa-logo')</span>
            <span>Videa Logo</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('vti-logo')</span>
            <span>VTi Logo</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('vue-logo')</span>
            <span>Vue Logo</span>
        </a>

        <a class="navbar-item" data-show="quickview" data-target="help">
            <span class="m-r-sm">@svg('waves')</span>
            <span>Waves</span>
        </a>
