<template>
    ...
    <figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;figure</span> <span class="na">class=</span><span class="s">"image is-128x128"</span><span class="nt">&gt;</span>
      <span class="nt">&lt;img</span> <span class="na">src=</span><span class="s">"/static/placeholder-128x128.png"</span><span class="nt">&gt;</span>
    <span class="nt">&lt;/figure&gt;</span></code></pre><button class="copy">Copy</button></figure>
        ...
        <table class="table is-bordered">
          <tbody>
            <tr>
              ...
              <td><figure class="image is-16x16"><img src="/static/placeholder-16x16.png"></figure></td>
              <td>16x16px</td>
            </tr>
            <tr>
              <td><code>image is-24x24</code></td>
              <td><figure class="image is-24x24"><img src="/static/placeholder-24x24.png"></figure></td>
              <td>24x24px</td>
            </tr>
            <tr>
              <td><code>image is-32x32</code></td>
              <td><figure class="image is-32x32"><img src="/static/placeholder-32x32.png"></figure></td>
              <td>32x32px</td>
            </tr>
            <tr>
              <td><code>image is-48x48</code></td>
              <td><figure class="image is-48x48"><img src="/static/placeholder-48x48.png"></figure></td>
              <td>48x48px</td>
            </tr>
            <tr>
              <td><code>image is-64x64</code></td>
              <td><figure class="image is-64x64"><img src="/static/placeholder-64x64.png"></figure></td>
              <td>64x64px</td>
            </tr>
            <tr>
              <td><code>image is-96x96</code></td>
              <td><figure class="image is-96x96"><img src="/static/placeholder-96x96.png"></figure></td>
              <td>96x96px</td>
            </tr>
            <tr>
              <td><code>image is-128x128</code></td>
              <td><figure class="image is-128x128"><img src="/static/placeholder-128x128.png"></figure></td>
              <td>128x128px</td>
            </tr>
          </tbody>
        </table>
        ...
        <div class="example">
          <figure class="image is-128x128">
            <img src="/static/placeholder-256x256.png">
          </figure>
        </div>

    <figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;figure</span> <span class="na">class=</span><span class="s">"image is-128x128"</span><span class="nt">&gt;</span>
      <span class="nt">&lt;img</span> <span class="na">src=</span><span class="s">"/static/placeholder-256x256.png"</span><span class="nt">&gt;</span>
    <span class="nt">&lt;/figure&gt;</span></code></pre><button class="copy">Copy</button></figure>
        ...
        <table id="images" class="table is-bordered">
          <tbody>
            <tr>
              ...
              <td><figure class="image is-square"><img src="/static/placeholder-480x480.png"></figure></td>
              <td>Square (or 1by1)</td>
            </tr>
            <tr>
              <td><code>image is-1by1</code></td>
              <td><figure class="image is-1by1"><img src="/static/placeholder-480x480.png"></figure></td>
              <td>1 by 1</td>
            </tr>
            <tr>
              <td><code>image is-4by3</code></td>
              <td><figure class="image is-4by3"><img src="/static/placeholder-640x480.png"></figure></td>
              <td>4 by 3</td>
            </tr>
            <tr>
              <td><code>image is-3by2</code></td>
              <td><figure class="image is-3by2"><img src="/static/placeholder-480x320.png"></figure></td>
              <td>3 by 2</td>
            </tr>
            <tr>
              <td><code>image is-16by9</code></td>
              <td><figure class="image is-16by9"><img src="/static/placeholder-640x360.png"></figure></td>
              <td>16 by 9</td>
            </tr>
            <tr>
              <td><code>image is-2by1</code></td>
              <td><figure class="image is-2by1"><img src="/static/placeholder-640x320.png"></figure></td>
              <td>2 by 1</td>
            </tr>
          </tbody>
        </table>
