<template>
    <div id="app"
        ...
        @click="$emit('close')"
    >
        <app-header class="vui-m-bottom--x-large"></app-header>
        ...
        <div class="l-container">
            ...
            <ul class="l-grid l-grid--tight">
                <li class="l-grid__item">
                    <div class="fpo">Tight Grid</div>
                </li>
                <li class="l-grid__item">
                    <div class="fpo">Tight Grid</div>
                </li>
            ...
            <ul class="l-grid l-grid--loose">
                <li class="l-grid__item">
                    <div class="fpo">Loose Grid</div>
                </li>
                <li class="l-grid__item">
                    <div class="fpo">Loose Grid</div>
                </li>
            ...
            <p>I used to declare grid patterns like
                <code>l-grid--2up</code>,
                <code>l-grid--3up</code>,
                <code>l-grid--4up</code> and so on, defining the breakpoints with media queries.
                CSS Grid changes all of that because the grids will automatically wrap items
                to fit the available space. So a lot of it depends on the width of the layout
                container (
                <code>l-container</code>).</p>

            <p>I'm working through how I should be naming these grid patterns. What are other
                people doing?</p>
...
<style lang="scss">
    ...
    /**
     * Tight grid
     * 1) Defines a grid that has breaks faster, fitting more
     *    items onto a row
     */
    ...
    /**
     * Loose grid
     * 1) Defines a grid that has breaks slower, fitting less
     *    items onto a row
     */
